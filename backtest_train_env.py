...
# Add these control variables at the beginning of the file
if_using_a2c = True
if_using_ddpg = False
if_using_ppo = False
if_using_td3 = False
...
plt.savefig(f'backtest_result_from_checkpoints_with_djia_and_error_bands_train_env_{algos_included[1:]}.png', dpi=300, bbox_inches='tight')
plt.show()
plt.close()

print(f"Processed {len(experiment_groups)} unique experiments.")
print(f"Results saved as 'backtest_result_from_checkpoints_with_djia_and_error_bands_train_env_{algos_included[1:]}.png'")
