#!/bin/bash
# Auto-generated run script for DDPG
...
drl_alg=ddpg # The deep reinforcement learning algorithm we are targeting to clone the behavior
model_type=dt
...
dataset_path=data/train_trajectories_ddpg_1_2024-10-12_12-03-04.pkl # Path to the trajectory data
test_trajectory_file=data/test_trajectories_ddpg_1_2024-10-12_12-03-56.pkl
