...
dropout=0.1
warmup_steps=2500
num_steps=10 # total number of training steps; i.e., how many times we call env.step() for training
...
train_full_trajectory_file=train_trajectories_a2c_1_2024-10-11_16-03-20.pkl
