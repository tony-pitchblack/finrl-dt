...
drl_alg=td3 # the deep reinforcement learning algorithm of which we are targeting to clone the behavior
model_type=dt
...
dataset_path=train_trajectories_td3_1_2024-10-12_10-43-47.pkl # path to the trajectory data; It's a list of dict, where each dict contains keys like "observations", "actions", "rewards", and "terminals"
test_trajectory_file=test_trajectories_td3_1_2024-10-12_10-43-58.pkl
